...
{
    //Akshay
  //  chrome.extension.getBackgroundPage().console.log("addlistener");
  if (checkWhitelisted(page, frame))
    return true;
  //  chrome.extension.getBackgroundPage().console.log("next");
//chrome.extension.getBackgroundPage().console.log("frame");
  ...
  setTimeout(onBeforeRequestAsync, 0, page, urlString,
                                      ...
                                      thirdParty, sitekey,
                                      specificOnly, filter);
//chrome.extension.getBackgroundPage().console.log("lets check: "+filter instanceof BlockingFilter);
